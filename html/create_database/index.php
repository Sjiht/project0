...
?>', $xmlstr);
	...
	// make MySQL connection and select database 'jharvard_project0'
	$link = mysql_connect('localhost', 'jharvard', 'crimson');
	if (!$link)
	{
    	die('Not connected : ' . mysql_error());
	}
	$db_selected = mysql_select_db('jharvard_project0', $link);
	if (!$db_selected)
	{
	...
	// create database jharvard_project0
	$sql = "CREATE DATABASE jharvard_project0";
